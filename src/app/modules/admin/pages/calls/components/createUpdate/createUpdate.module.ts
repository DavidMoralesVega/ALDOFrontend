...
import { CallCreateUpdateComponent } from './container/createUpdate.component';
import { JsonAsyncModule } from 'src/app/core/pipes/json-async/json-async.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';

@NgModule({
	declarations: [CallCreateUpdateComponent],
	imports: [
		CommonModule,
		ReactiveFormsModule,
		MatDialogModule,
	...
	exports: [CallCreateUpdateComponent]
})
export class CallCreateUpdateModule {}
