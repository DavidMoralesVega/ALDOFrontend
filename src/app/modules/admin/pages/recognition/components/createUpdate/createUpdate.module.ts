...
import { RecognitionCreateUpdateComponent } from './container/createUpdate.component';

@NgModule({
	declarations: [RecognitionCreateUpdateComponent],
	imports: [
		CommonModule,
		ReactiveFormsModule,
		MatDialogModule,
	...
	exports: [RecognitionCreateUpdateComponent]
})
export class RecognitionCreateUpdateModule {}
