...
import { ResolutionsCreateUpdateComponent } from './container/createUpdate.component';
import { JsonAsyncModule } from 'src/app/core/pipes/json-async/json-async.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';

@NgModule({
	declarations: [ResolutionsCreateUpdateComponent],
	imports: [
		CommonModule,
		ReactiveFormsModule,
		MatDialogModule,
	...
	exports: [ResolutionsCreateUpdateComponent]
})
export class ResolutionsCreateUpdateModule {}
