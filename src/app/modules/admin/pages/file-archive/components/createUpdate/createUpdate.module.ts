...
import { FileArchiveCreateUpdateComponent } from './container/createUpdate.component';
import { JsonAsyncModule } from 'src/app/core/pipes/json-async/json-async.module';
import { MatAutocompleteModule } from '@angular/material/autocomplete';

@NgModule({
	declarations: [FileArchiveCreateUpdateComponent],
	imports: [
		CommonModule,
		ReactiveFormsModule,
		MatDialogModule,
	...
	exports: [FileArchiveCreateUpdateComponent]
})
export class FileArchiveCreateUpdateModule {}
